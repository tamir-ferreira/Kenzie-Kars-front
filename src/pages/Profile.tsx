  ...
  return (
    <>
      ...
      <main className="flex flex-col items-center gap-14 w-full min-h-[90vh] bg-grey-8 ">
        <section className="flex h-fit flex-col container  gap-6 z-[7] relative bg-white-fixed mt-40 sm:p-11 rounded sm:w-[1240px] ">
        ...
        <section className="flex flex-col justify-start max-w-[1392px] mt-4 w-screen sm:items-start">
          {!isSeller && <h3 className="text-heading-5-600 mb-16 -translate-x-16 ">Anúncios</h3>}
