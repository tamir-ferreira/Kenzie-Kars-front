  ...
  return (
    <>
      ...
      <main className="bg-grey-7">
        <div className=" w-[95%] sm:w-7/12 rounded bg-grey-10 ml-2 sm:ml-[11rem] py-7 px-7 sm:p-11 mt-10 mb-4">
          <h3 className="mb-6 text-heading-6-600 mt-8">Descrição</h3>
          <p className="text-body-1-400 leading-7 text-grey-2">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias,
            modi! Pariatur eaque sequi blanditiis et commodi optio earum, ipsum
            animi excepturi, nihil, praesentium atque vel iure quaerat qui
            recusandae velit? Lorem, ipsum dolor sit amet consectetur
            adipisicing elit. Esse, magni. Iste magni earum consectetur aliquam
            ratione commodi hic quidem rerum? Perferendis natus soluta
